...
<div class="container-fluid p-3 " style="background-color: #2d3142;">
    <div class="container-fluid p-3 " style="display: flex; align-items: center; justify-content:center;">
        <h1 class="text-light mr-3"> <strong> User Detail </strong></h1>
    ...
    <div class="container-fluid p-3 d-flex justify-content-center">
        <div class="row text-center">
            ...
            <button class="btn btn-outline-custom m-3" onclick="showCard('cardalamat'); buttonKlikAlamat();" id="btneditalamat">
                <strong>Edit Alamat</strong></button>
        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-4 pl-5">
                            <div class="row text-center">
                                <img id="profilePicPreview" alt="Profile Picture" class="img-fluid rounded-circle">
                            </div>
                            <div class="row text-center">
        ...
        <div class="card m-3" style="border:none;" id="cardalamat" style="display:none;">
            <div class="card-header" id="usernameheader2"></div>
    ...
    function fetchProfileData() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#usernameheader2").html(`<strong>${user.username}</strong>`);
